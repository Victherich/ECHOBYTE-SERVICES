    ...
    <>
      <section className="bg-[#111827] text-white min-h-screen py-16 px-6 font-sans">
        ...
        <div className="max-w-3xl mx-auto space-y-6 text-gray-200">
          ...
          <h2 className="text-2xl font-semibold text-[#facc15] mt-8">2. Eligibility and Engagement</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-[#facc15] mt-8">3. Code of Conduct and Company Policies</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-[#facc15] mt-8">4. Compensation and Benefits</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-[#facc15] mt-8">5. Confidentiality</h2>
          <p>
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li>Keep all such information strictly confidential.</li>
            <li>Not disclose, directly or indirectly, any confidential information to any third party.</li>
            <li>Use confidential information solely for the benefit of ECHOBYTE CONCEPT and for performing your assigned duties.</li>
            <li>Return all confidential information, documents, and company property upon termination of your engagement.</li>
            <li>This confidentiality obligation continues indefinitely even after your internship or employment ends.</li>
          </ul>

          <h2 className="text-2xl font-semibold text-[#facc15] mt-8">6. Intellectual Property (IP) Rights</h2>
          <p>
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li>Promptly disclose all such Inventions to ECHOBYTE CONCEPT.</li>
            <li>Assign and hereby irrevocably assign to ECHOBYTE CONCEPT all your rights, title, and interest in and to such Inventions.</li>
            <li>Assist ECHOBYTE CONCEPT, at its expense, in obtaining, maintaining, and enforcing patents, copyrights, and other intellectual property rights worldwide for these Inventions.</li>
            <li>Waive any moral rights you may have in such Inventions.</li>
          </ul>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-[#facc15] mt-8">7. Non-Compete and Non-Solicitation (Applicable to Employees/Senior Interns, if stipulated)</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-[#facc15] mt-8">8. Data Protection and Privacy</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-[#facc15] mt-8">9. Termination of Engagement</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-[#facc15] mt-8">10. Limitation of Liability</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-[#facc15] mt-8">13. Entire Agreement</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-[#facc15] mt-8">14. Governing Law and Dispute Resolution</h2>
          <p>
          ...
          <p>We reserve the right to update these Terms and Conditions from time to time. We will notify you of any material changes by posting the new Terms on this page or through other appropriate communication channels. Your continued internship or employment after such modifications will constitute your your acknowledgment of the modified Terms and agreement to abide and be bound by them.</p>

          <h2 className="text-2xl font-semibold text-[#facc15] mt-8">16. Contact Us</h2>
          <p>
...
export default TermsAndConditionsInternshipEmployment;