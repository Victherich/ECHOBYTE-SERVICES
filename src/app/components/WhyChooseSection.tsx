...
const WhyChooseSection: React.FC = () => {
  return (
    <section className="bg-gradient-to-br from-gray-800 to-gray-900 py-20 px-6 text-center">
      <h2 className="text-3xl font-bold text-white mb-8">Why ECHOBYTE CONCEPT?</h2>
